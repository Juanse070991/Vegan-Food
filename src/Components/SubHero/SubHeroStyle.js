...
export const SubHeroWrapper = styled.div`
  ...
  display: flex;
  height: 6rem;
  /* border-bottom: solid 1px var(--verdeOscuro); */
  /* border-top: solid 1px var(--verdeOscuro); */
  display: flex;
  align-items: center;
...
export const DivIzq = styled.div`
  border-right: 1px var(--verdeOscuro) solid;
  border-left: 1px var(--verdeOscuro) solid;
  height: 4rem;
  width: 16rem;
  display: flex;
  align-items: center;
